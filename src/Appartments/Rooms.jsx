        ...
        <div className="bg-slate-200">
           ...
           <Link to={'/'} > <button className="btn btn-warning " > Back to Home  <FaHome/> </button></Link>
            ...
            <div className="flex justify-center mb-8 gap-2 items-center" >
                ...
                <p>pages--</p>
                <button onClick={handlepreviouspage} className="btn btn-warning" >Prev</button>

               

                {
                    pages?.map(page=><button onClick={()=>setcurrentpage(page)} className={currentpage===page && "btn btn-warning"} key={page}> {page} </button>)
                } 
                ...
                <button onClick={handlenextpage} className="btn btn-warning" >Next</button>
